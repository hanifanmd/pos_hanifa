...
<style>
    ...
    .hero-banner-form {
        background: #a8204d; /* Menyesuaikan warna magenta dari gambar */
        border-radius: 16px;
        color: #fff;
...
<div class="page-wrapper">
    <div class="container">
        ...
        <div class="hero-banner-form p-4 p-md-5 mb-4 d-flex flex-column flex-md-row justify-content-between align-items-center">
            <div>
                <span class="badge bg-white text-danger px-3 py-1 rounded-pill fw-bold mb-2 shadow-sm" style="color: #a8204d !important;">
            ...
            <div class="mt-3 mt-md-0">
                <a href="{{ route('admin.users') }}" class="btn btn-light rounded-pill px-4 fw-bold shadow-sm" style="color: #a8204d;">
